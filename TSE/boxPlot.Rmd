...
full_ds$similarity = as.numeric(full_ds$similarity)

colnames(full_ds)
nrow(full_ds)

full_ds <- sqldf("select * from full_ds where benign = 'True' and source = 'repack'")
...
boxplot(similarity~dataset, data = ds, xlab="Datasets", ylab="Similarity Score",outline=F)
```
...
hist(gappusin$similarity, main="", xlab="Similarity Score", ylab="Frequency")
